    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
            <div class="form-row">
               <div class="col">
                 <input type="tex" class="form-control" placeholder="clave">
...
@push('scripts')
     <script type="text/javascript" scr="{{asset('js/apis/especies.js')}}"></script>
     <script type="text/javascript" scr="{{asset('js/vue-resource.js')}}"></script>
@endpush
